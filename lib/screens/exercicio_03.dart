...
class _Exercicio_03State extends State<Exercicio_03> {
  ...
  Future _exercicio03(list) async {
    var params = <String, dynamic>{
      "from": [_valorController.text]
    };
    try {
      List result = await platform.invokeMethod("_exercicio03", params);
      notas = result;
  ...
  // Future _exercicio03(valor_nota) async {
  //   try {
  //     final List result = await platform.invokeMethod("_exercicio03", {
  //       "notas": _valorController.text,
  //     });
  //     notas = result;
  //   } on PlatformException catch (e) {
  //     print(e.message);
